...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#050B14] text-slate-100 flex flex-col justify-between p-6 sm:p-10 relative overflow-hidden font-sans select-none">
      ...
      {/* Contenido central */}
      <main className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center my-auto py-8">
...
<div className="lg:col-span-6 flex justify-center lg:justify-end">
  <div className="w-full max-w-md bg-[#0D1527]/90 backdrop-blur-md border border-slate-800/80 rounded-3xl p-8 sm:p-10 shadow-2xl relative pt-20 mt-24">
    ...
    <div className="space-y-1 mb-8 text-left">
      ...
      {/* Footer */}
      <footer className="relative z-10 flex flex-col sm:flex-row items-center justify-between text-[11px] text-slate-500 gap-4 pt-6 border-t border-slate-900/60">

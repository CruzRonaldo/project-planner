...
export const workOrderPriorities = [
  { id: 'high', label: 'Alta prioridad', className: 'border-red-500/25 bg-red-500/10 text-red-400' },
  { id: 'medium', label: 'Media', className: 'border-amber-500/25 bg-amber-500/10 text-amber-400' },
  { id: 'low', label: 'Baja', className: 'border-slate-500/25 bg-slate-500/10 text-slate-400' },
];
export const workOrderStatuses = [
  { id: 'in-progress', label: 'En progreso', className: 'border-amber-500/25 bg-amber-500/10 text-amber-400' },
  { id: 'completed', label: 'Completada', className: 'border-emerald-500/25 bg-emerald-500/10 text-emerald-400' },
  { id: 'planned', label: 'Planificada', className: 'border-blue-500/25 bg-blue-500/10 text-blue-400' },
];

...
import { Briefcase, LayoutDashboard, TrendingUp } from 'lucide-react';
...
export default function MobileNavigation({ activeView, onNavigate }) {
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-50 grid grid-cols-3 border-t border-[#30363d] bg-[#10141b]/95 shadow-[0_-10px_30px_rgba(0,0,0,0.3)] backdrop-blur lg:hidden"
